      ...
      <form>
        <div className="row justify-content-center my-5">
          <div className="col-md-5 my-5 text-start  shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <div>
              <input onChange={(e) => setFullName(e.target.value)} name="full_name" type="text" placeholder="your name" className="form-control" />
              {validation.fields?.full_name ? <p className="alert alert-warning">{validation.fields.full_name.message}</p> : ""}
              <input onChange={(e) => setEmail(e.target.value)} name="email" type="text" placeholder="email" className="form-control" />
              ...
              <input onChange={(e) => setCPassword(e.target.value)} type="password" name="confirm_password" placeholder="confirm password" className="form-control" />
